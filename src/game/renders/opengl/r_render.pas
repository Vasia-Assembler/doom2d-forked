...
{$ENDIF}
  ...
  begin
    ...
    begin
      ...
      r_Render_DrawText(IntToStr(gTeamStat[TEAM_RED].Goals), x + w - 16 - fw, y + 240 - 72 - 4, TEAMCOLOR[TEAM_RED].R, TEAMCOLOR[TEAM_RED].G, TEAMCOLOR[TEAM_RED].B, 255, menufont, TBasePoint.BP_RIGHTUP);
      ...
      r_Render_DrawText(IntToStr(gTeamStat[TEAM_BLUE].Goals), x + w - 16 - fw, y + 240 - 32 - 4, TEAMCOLOR[TEAM_BLUE].R, TEAMCOLOR[TEAM_BLUE].G, TEAMCOLOR[TEAM_BLUE].B, 255, menufont, TBasePoint.BP_RIGHTUP);
    end;
    ...
    begin
      ...
      begin
        case team of
         ...
         r_Render_DrawText(IntToStr(gTeamStat[team].Goals), x + w1, yy, r, g, b, 255, stdfont, TBasePoint.BP_LEFTUP);
         INC(yy, ch);
