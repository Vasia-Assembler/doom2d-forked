...
{$ENDIF}
  ...
  begin
    ...
    begin
      ...
      r_Render_DrawText(IntToStr(gTeamStat[TEAM_BLUE].Goals), x + w - 16 - fw, y + 240 - 32 - 4, TEAMCOLOR[TEAM_RED].R, TEAMCOLOR[TEAM_RED].G, TEAMCOLOR[TEAM_RED].B, 255, menufont, TBasePoint.BP_RIGHTUP);
    end;
